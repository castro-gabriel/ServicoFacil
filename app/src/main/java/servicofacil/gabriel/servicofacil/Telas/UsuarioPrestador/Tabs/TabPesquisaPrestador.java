...
public class TabPesquisaPrestador extends Fragment implements OnMapReadyCallback{

    MapView MapView;
    View vView;
    public TabPesquisaPrestador(){
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        vView = inflater.inflate(R.layout.tab_pesquisa_prestador, container, false);
